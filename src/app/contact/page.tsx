    ...
    <section className="px-4 pb-12 pt-10 sm:px-6 lg:px-8 lg:pb-16 lg:pt-14">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-6 grid gap-3 md:grid-cols-3">
          <article className="mix-surface reveal p-5">
          ...
          <article className="mix-surface reveal reveal-delay-1 p-5">
            <p className="mix-kicker mb-2">Instagram</p>
            <a
              className="mix-contact-link"
              href="https://www.instagram.com/themixharvard/"
              target="_blank"
              rel="noreferrer"
            >
              @themixharvard
          ...
          <article className="mix-surface reveal reveal-delay-2 p-5">
